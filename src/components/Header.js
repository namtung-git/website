                ...
                <Navbar fixed="top" expand="lg" collapseOnSelect="true" className={this.state.isTop ? 'default' : 'sticky'}>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ml-auto">
                            ...
                            <ScrollIntoView selector=""><Nav.Link className="resume-link" href="https://drive.google.com/file/d/18akb1_Lpos0jD-FKMlojet2HkNwglJN-/view?usp=sharing">Resume</Nav.Link></ScrollIntoView>
                        </Nav>
                    </Navbar.Collapse>
                </Navbar>
