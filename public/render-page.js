(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("/Users/khele/Documents/Me/website/node_modules/@reach/router/index.js"), require("fs"), require("/Users/khele/Documents/Me/website/node_modules/lodash/lodash.js"), require("path"), require("react"), require("react-dom/server"), require("react-helmet"));
	else if(typeof define === 'function' && define.amd)
		define("lib", ["/Users/khele/Documents/Me/website/node_modules/@reach/router/index.js", "fs", "/Users/khele/Documents/Me/website/node_modules/lodash/lodash.js", "path", "react", "react-dom/server", "react-helmet"], factory);
	else if(typeof exports === 'object')
		exports["lib"] = factory(require("/Users/khele/Documents/Me/website/node_modules/@reach/router/index.js"), require("fs"), require("/Users/khele/Documents/Me/website/node_modules/lodash/lodash.js"), require("path"), require("react"), require("react-dom/server"), require("react-helmet"));
	else
		root["lib"] = factory(root["/Users/khele/Documents/Me/website/node_modules/@reach/router/index.js"], root["fs"], root["/Users/khele/Documents/Me/website/node_modules/lodash/lodash.js"], root["path"], root["react"], root["react-dom/server"], root["react-helmet"]);
...
const trimmedPathname=Object(_strip_prefix__WEBPACK_IMPORTED_MODULE_1__["default"])(pathname,"/website")// Remove any hashfragment
...
pathContext:pageData.result?pageData.result.pageContext:undefined};const pageElement=createElement(syncRequires.components[componentChunkName],props);const wrappedPage=apiRunner(`wrapPageElement`,{element:pageElement,props},pageElement,({result})=>{return{element:result,props};}).pop();return wrappedPage;}}const routerElement=/*#__PURE__*/React.createElement(ServerLocation,{url:`${"/website"}${pagePath}`},/*#__PURE__*/React.createElement(Router,{id:"gatsby-focus-wrapper",baseuri:"/website"},/*#__PURE__*/React.createElement(RouteHandler,{path:"/*"})),/*#__PURE__*/React.createElement("div",RouteAnnouncerProps));const bodyComponent=apiRunner(`wrapRootElement`,{element:routerElement,pathname:pagePath},routerElement,({result})=>{return{element:result,pathname:pagePath};}).pop();// Let the site or plugin render the page component.
apiRunner(`replaceRenderer`,{bodyComponent,replaceBodyHTMLString,setHeadComponents,setHtmlAttributes,setBodyAttributes,setPreBodyComponents,setPostBodyComponents,setBodyProps,pathname:pagePath,pathPrefix:"/website"});// If no one stepped up, we'll handle it.
...
const scriptChunkMapping=`/*<![CDATA[*/window.___chunkMapping=${JSON.stringify(chunkMapping)};/*]]>*/`;postBodyComponents.push(/*#__PURE__*/React.createElement("script",{key:`chunk-mapping`,id:`gatsby-chunk-mapping`,dangerouslySetInnerHTML:{__html:scriptChunkMapping}}));let bodyScripts=[];if(chunkMapping[`polyfill`]){chunkMapping[`polyfill`].forEach(script=>{const scriptPath=`${"/website"}${script}`;bodyScripts.push(/*#__PURE__*/React.createElement("script",{key:scriptPath,src:scriptPath,noModule:true}));});}// Filter out prefetched bundles as adding them as a script tag
// would force high priority fetching.
bodyScripts=bodyScripts.concat(scripts.filter(s=>s.rel!==`prefetch`).map(s=>{const scriptPath=`${"/website"}/${JSON.stringify(s.name).slice(1,-1)}`;return/*#__PURE__*/React.createElement("script",{key:scriptPath,src:scriptPath,async:true});}));(_postBodyComponents=postBodyComponents).push.apply(_postBodyComponents,Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(bodyScripts));apiRunner(`onPreRenderHTML`,{getHeadComponents,replaceHeadComponents,getPreBodyComponents,replacePreBodyComponents,getPostBodyComponents,replacePostBodyComponents,pathname:pagePath,pathPrefix:"/website"});const html=`<!DOCTYPE html>${renderToStaticMarkup(/*#__PURE__*/React.createElement(Html,Object.assign({},bodyProps,{headComponents:headComponents,htmlAttributes:htmlAttributes,bodyAttributes:bodyAttributes,preBodyComponents:preBodyComponents,postBodyComponents:postBodyComponents,body:bodyHtml,path:pagePath})))}`;callback(null,html);});
...
/***/ "./node_modules/@rehooks/window-size/index.js":
/*!****************************************************!*\
  !*** ./node_modules/@rehooks/window-size/index.js ***!
  \****************************************************/
/*! no static exports found */
...
let { useState, useEffect } = __webpack_require__(/*! react */ "react");
...
var getGlobalPathPrefix = function getGlobalPathPrefix() {
  return  false ? undefined : "/website";
};
...
"use strict";
function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}var React=_interopDefault(__webpack_require__(/*! react */ "react")),ScrollInto=function(e){function t(){var e={behavior:r?"smooth":"instant"};s&&(e.block="start",e.inline="nearest"),document.querySelector(n).scrollIntoView(e)}var o=e.children,n=e.selector,i=e.smooth,r=void 0===i||i,l=e.style,c=void 0===l?{}:l,a=e.alignToTop,s=void 0!==a&&a,u=e.className,f=void 0===u?"":u,d=e.onClick;return React.createElement("div",{style:c,className:f,onClick:function(e){"function"==typeof d?(d(e),setTimeout(t,1e3/60)):t()}},o)};module.exports=ScrollInto;
...
/***/ "./src/assets/images/avatar-md.png":
/*!*****************************************!*\
  !*** ./src/assets/images/avatar-md.png ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "static/avatar-md-322f6cad225a9684b513d392cd0ac167.png";

/***/ }),

/***/ "./src/assets/images/avatar-xs.png":
/*!*****************************************!*\
  !*** ./src/assets/images/avatar-xs.png ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "static/avatar-xs-d98f3081e221116f1c9fc9e270dbaa50.png";
...
module.exports = __webpack_require__.p + "static/logo-fd66c3b263f9dd10394f2d106cb8b9b0.png";

/***/ }),

/***/ "./src/assets/images/project1a.png":
/*!*****************************************!*\
  !*** ./src/assets/images/project1a.png ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "static/project1a-158cfbe008a63375789d12594d8e7b46.png";

/***/ }),

/***/ "./src/assets/images/project1b.png":
/*!*****************************************!*\
  !*** ./src/assets/images/project1b.png ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "static/project1b-ed7be4430470294496ca9e6bd2de59a5.png";

/***/ }),

/***/ "./src/assets/images/project1c.png":
/*!*****************************************!*\
  !*** ./src/assets/images/project1c.png ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "static/project1c-6e6004e119f412cb9634cb032fd2aa83.png";

/***/ }),

/***/ "./src/assets/images/project2a.png":
/*!*****************************************!*\
  !*** ./src/assets/images/project2a.png ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "static/project2a-21756eb2165e78e55c79812d338272e3.png";

/***/ }),

/***/ "./src/assets/images/project2b.png":
/*!*****************************************!*\
  !*** ./src/assets/images/project2b.png ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "static/project2b-1791d4cceb5f25b18e7b9d2c5fc990b3.png";

/***/ }),

/***/ "./src/assets/images/project2c.png":
/*!*****************************************!*\
  !*** ./src/assets/images/project2c.png ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "static/project2c-f73b87e5c4deb07dbfb85a09e95fada9.png";

/***/ }),

/***/ "./src/assets/images/project3a.png":
/*!*****************************************!*\
  !*** ./src/assets/images/project3a.png ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "static/project3a-eebe132df5b4a532b746b7eaac52b63e.png";

/***/ }),

/***/ "./src/assets/images/project3b.png":
/*!*****************************************!*\
  !*** ./src/assets/images/project3b.png ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "static/project3b-1b3006e551dc524ac1404431a23ca35c.png";

/***/ }),

/***/ "./src/assets/images/project3c.png":
/*!*****************************************!*\
  !*** ./src/assets/images/project3c.png ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "static/project3c-f592d1920e5941aa299df4a6b69cdc2f.png";

/***/ }),

/***/ "./src/assets/images/project3d.png":
/*!*****************************************!*\
  !*** ./src/assets/images/project3d.png ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "static/project3d-e458b5d4663ae35e4560d04ccaed21da.png";
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_scroll_into_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-scroll-into-view */ "./node_modules/react-scroll-into-view/dist/index.js");
/* harmony import */ var react_scroll_into_view__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_scroll_into_view__WEBPACK_IMPORTED_MODULE_1__);
const Banner=()=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section",{id:"banner"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{class:"inner"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p",{className:"greeting"},"Hi, my name is"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1",{className:"name"},"Khe Le."),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1",{className:"pitch"},"Wie geht's?"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p",{className:"intro"},"Welcome to my website, where I share both of my professional and personal journeys."),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_scroll_into_view__WEBPACK_IMPORTED_MODULE_1___default.a,{selector:"#about"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button",{type:"button",className:"banner-button btn btn-lg btn-outline-light"},"Discover",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span",{className:"icon fa-long-arrow-right"})))));/* harmony default export */ __webpack_exports__["default"] = (Banner);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
const Contact=()=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section",{id:"contact"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"container-fluid"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"front"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2",{className:"subtitle"},"What's next?"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1",{className:"title"},"Get In Touch"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p",{className:"content"},"Feel free to contact me. I'm always open to discussing new projects, creative ideas, or opportunities to be part of your visions."),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a",{href:"mailto:levanyenkhe@gmail.com"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button",{className:"email-button btn"},"Say Hello")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr",null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul",{className:"contact-social-icons"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a",{className:"icon alt2 fa-github",href:"https://github.com/khe-le"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span",{className:"label"},"GitHub"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a",{className:"icon alt2 fa-linkedin",href:"https://www.linkedin.com/in/khe-v-le/"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span",{className:"label"},"LinkedIn"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a",{className:"icon alt2 fa-instagram",href:"https://www.instagram.com/khe_levy/?hl=en"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span",{className:"label"},"Instagram"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a",{className:"icon alt2 fa-youtube",href:"https://www.youtube.com/channel/UCVLkEtPgGuJr2MtABha7_og"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span",{className:"label"},"Youtube")))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p",{className:"claim"},"Designed & Built by Khe Le")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p",{className:"copyright"},"\xA9 2020 Khe Le")));/* harmony default export */ __webpack_exports__["default"] = (Contact);
...
/* harmony import */ var react_scroll_into_view__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-scroll-into-view */ "./node_modules/react-scroll-into-view/dist/index.js");
...
class Header extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component{constructor(props){super(props);this.handleScroll=e=>{const isTop=window.scrollY<100;if(isTop!==this.state.isTop){this.setState({isTop});}};this.state={isTop:true};}componentDidMount(){window.addEventListener("scroll",this.handleScroll);}componentWillUnmount(){window.addEventListener("scroll",this.handleScroll);}render(){return/*#__PURE__*/ (/* This header consists of a navbar and a social link bar */react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("header",{id:"header"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Navbar__WEBPACK_IMPORTED_MODULE_1__["default"],{fixed:"top",expand:"lg",collapseOnSelect:"true",className:this.state.isTop?'default':'sticky'},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_scroll_into_view__WEBPACK_IMPORTED_MODULE_3___default.a,{selector:"#banner"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Navbar__WEBPACK_IMPORTED_MODULE_1__["default"].Brand,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{src:_assets_images_logo_png__WEBPACK_IMPORTED_MODULE_4___default.a,className:`d-inline-block align-top ${this.state.isTop?'logo-default':'logo-sticky'}`,alt:"Khe Le Website Logo"}))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Navbar__WEBPACK_IMPORTED_MODULE_1__["default"].Toggle,{"aria-controls":"basic-navbar-nav",className:"hamburger"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Navbar__WEBPACK_IMPORTED_MODULE_1__["default"].Collapse,{id:"basic-navbar-nav"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Nav__WEBPACK_IMPORTED_MODULE_2__["default"],{className:"ml-auto"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_scroll_into_view__WEBPACK_IMPORTED_MODULE_3___default.a,{selector:"#about"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Nav__WEBPACK_IMPORTED_MODULE_2__["default"].Link,{className:"section-link"},"About")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_scroll_into_view__WEBPACK_IMPORTED_MODULE_3___default.a,{selector:"#work"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Nav__WEBPACK_IMPORTED_MODULE_2__["default"].Link,{className:"section-link"},"Work")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_scroll_into_view__WEBPACK_IMPORTED_MODULE_3___default.a,{selector:"#contact"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Nav__WEBPACK_IMPORTED_MODULE_2__["default"].Link,{className:"section-link"},"Contact")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_scroll_into_view__WEBPACK_IMPORTED_MODULE_3___default.a,{selector:""},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Nav__WEBPACK_IMPORTED_MODULE_2__["default"].Link,{className:"resume-link",href:"https://drive.google.com/file/d/18akb1_Lpos0jD-FKMlojet2HkNwglJN-/view?usp=sharing"},"Resume"))))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"header-social-icons"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a",{className:"icon alt fa-file",href:"https://drive.google.com/file/d/18akb1_Lpos0jD-FKMlojet2HkNwglJN-/view?usp=sharing"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span",{className:"label"},"Resume"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a",{className:"icon alt fa-github",href:"https://github.com/khe-le"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span",{className:"label"},"GitHub"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a",{className:"icon alt fa-linkedin",href:"https://www.linkedin.com/in/khe-v-le/"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span",{className:"label"},"LinkedIn"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a",{className:"icon alt fa-instagram",href:"https://www.instagram.com/khe_levy/?hl=en"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span",{className:"label"},"Instagram"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a",{className:"icon alt fa-youtube",href:"https://www.youtube.com/channel/UCVLkEtPgGuJr2MtABha7_og"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span",{className:"label"},"Youtube")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"vertical-line"}))))));}}/* harmony default export */ __webpack_exports__["default"] = (Header);
...
/* harmony import */ var _rehooks_window_size__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @rehooks/window-size */ "./node_modules/@rehooks/window-size/index.js");
/* harmony import */ var _rehooks_window_size__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_rehooks_window_size__WEBPACK_IMPORTED_MODULE_2__);
class Project extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component{constructor(props){super(props);this.handleResize=e=>{this.setState({windowWidth:window.innerWidth});};this.state={windowWidth:window.innerWidth};}componentDidMount(){window.addEventListener("resize",this.handleResize);}componentWillUnmount(){window.addEventListener("resize",this.handleResize);}render(){const{windowWidth}=this.state;if(windowWidth>992){// Display 3 Slides: Screen > Medium Breakpoint 
return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_1__["default"],{id:"project"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_1__["default"].Item,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{className:"d-block w-100 project-image",src:this.props.image1,alt:"First slide"})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_1__["default"].Item,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{className:"d-block w-100 project-image",src:this.props.image2,alt:"Second slide"})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_1__["default"].Item,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{className:"d-block w-100 project-image",src:this.props.image3,alt:"Third slide"})));}else{// Display 4 Slides: Screen <= Medium Breakpoint 
return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_1__["default"],{id:"project"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_1__["default"].Item,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{className:"d-block w-100 project-description",src:this.props.image0,alt:"Project Description"})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_1__["default"].Item,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{className:"d-block w-100 project-image",src:this.props.image1,alt:"First slide"})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_1__["default"].Item,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{className:"d-block w-100 project-image",src:this.props.image2,alt:"Second slide"})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_1__["default"].Item,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{className:"d-block w-100 project-image",src:this.props.image3,alt:"Third slide"})));}}}/* harmony default export */ __webpack_exports__["default"] = (Project);
...
class Layout extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component{constructor(props){super(props);this.state={loading:'is-loading'};}componentDidMount(){this.timeoutId=setTimeout(()=>{this.setState({loading:''});},100);}componentWillUnmount(){if(this.timeoutId){clearTimeout(this.timeoutId);}}render(){const{children}=this.props;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:`body ${this.state.loading}`},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{id:"wrapper"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Header__WEBPACK_IMPORTED_MODULE_2__["default"],null),children,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Contact__WEBPACK_IMPORTED_MODULE_3__["default"],null)));}}/* harmony default export */ __webpack_exports__["default"] = (Layout);
...
/* harmony import */ var _assets_images_avatar_md_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../assets/images/avatar-md.png */ "./src/assets/images/avatar-md.png");
/* harmony import */ var _assets_images_avatar_md_png__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_assets_images_avatar_md_png__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _assets_images_avatar_xs_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../assets/images/avatar-xs.png */ "./src/assets/images/avatar-xs.png");
/* harmony import */ var _assets_images_avatar_xs_png__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_assets_images_avatar_xs_png__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _assets_images_project1a_png__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../assets/images/project1a.png */ "./src/assets/images/project1a.png");
/* harmony import */ var _assets_images_project1a_png__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_assets_images_project1a_png__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _assets_images_project1b_png__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../assets/images/project1b.png */ "./src/assets/images/project1b.png");
/* harmony import */ var _assets_images_project1b_png__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_assets_images_project1b_png__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _assets_images_project1c_png__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../assets/images/project1c.png */ "./src/assets/images/project1c.png");
/* harmony import */ var _assets_images_project1c_png__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_assets_images_project1c_png__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _assets_images_project3d_png__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../assets/images/project3d.png */ "./src/assets/images/project3d.png");
/* harmony import */ var _assets_images_project3d_png__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_assets_images_project3d_png__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _assets_images_project2a_png__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../assets/images/project2a.png */ "./src/assets/images/project2a.png");
/* harmony import */ var _assets_images_project2a_png__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_assets_images_project2a_png__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _assets_images_project2b_png__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../assets/images/project2b.png */ "./src/assets/images/project2b.png");
/* harmony import */ var _assets_images_project2b_png__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_assets_images_project2b_png__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _assets_images_project2c_png__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../assets/images/project2c.png */ "./src/assets/images/project2c.png");
/* harmony import */ var _assets_images_project2c_png__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_assets_images_project2c_png__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _assets_images_project3a_png__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../assets/images/project3a.png */ "./src/assets/images/project3a.png");
/* harmony import */ var _assets_images_project3a_png__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_assets_images_project3a_png__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _assets_images_project3b_png__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../assets/images/project3b.png */ "./src/assets/images/project3b.png");
/* harmony import */ var _assets_images_project3b_png__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_assets_images_project3b_png__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var _assets_images_project3c_png__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../assets/images/project3c.png */ "./src/assets/images/project3c.png");
/* harmony import */ var _assets_images_project3c_png__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_assets_images_project3c_png__WEBPACK_IMPORTED_MODULE_16__);
/* Profile Pictures *//* Project Images with width:height ratio of 1.6:1 */ //Project 1
//Project 2
//Project 3
class HomeIndex extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component{render(){return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_2__["default"],null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_helmet__WEBPACK_IMPORTED_MODULE_1___default.a,{title:"Khe Le",meta:[{name:'description',content:'Personal Website'},{name:'keywords',content:'personal, webstite, portfolio'}]}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Banner__WEBPACK_IMPORTED_MODULE_3__["default"],null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{id:"main"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section",{id:"about"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"container-fluid"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"row"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"col-lg-5"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{className:"square-avatar",src:_assets_images_avatar_md_png__WEBPACK_IMPORTED_MODULE_5___default.a,alt:"Avatar"})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"about-details col-lg-7"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2",{className:"subtitle"},"My intro"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1",{className:"title"},"About me"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr",null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{className:"round-avatar",src:_assets_images_avatar_xs_png__WEBPACK_IMPORTED_MODULE_6___default.a,alt:"Avatar"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p",null,"I'm a Computer Science major at Connecticut College in New London, CT. I have a deep interest in creating interactive websites, applications and enjoy building products that provide pixel-perfect, performant experience. I'm dedicated to my work and incredibly passionate in pursuing a career in Software Engineering."),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{class:"profile row"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"profile-column col-md-6"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b",null,"Full Name:")," Khe Le"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b",null,"School:")," Connecticut College"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b",null,"Major:")," Computer Science"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b",null,"Expected Graduation:")," 2024")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"profile-column col-md-6"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b",null,"Origin:")," Ho Chi Minh, Vietnam"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b",null,"DOB:")," July 4, 2001"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b",null,"Language:")," English, Vietnamese"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b",null,"Email:")," levanyenkhe@gmail.com"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a",{href:"https://drive.google.com/file/d/18akb1_Lpos0jD-FKMlojet2HkNwglJN-/view?usp=sharing"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button",{type:"button",className:"cv-button btn"},"Download CV")))))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section",{id:"work"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"container-fluid"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1",{className:"title"},"Some projects I've built"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1",{className:"vertical-line"},"|"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"row"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"col-lg-7"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Project__WEBPACK_IMPORTED_MODULE_4__["default"],{image0:_assets_images_project3d_png__WEBPACK_IMPORTED_MODULE_10___default.a,image1:_assets_images_project1a_png__WEBPACK_IMPORTED_MODULE_7___default.a,image2:_assets_images_project1b_png__WEBPACK_IMPORTED_MODULE_8___default.a,image3:_assets_images_project1c_png__WEBPACK_IMPORTED_MODULE_9___default.a})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"description right"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2",{className:"category"},"UI Design Project"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2",{className:"name"},"MyTIN App"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p",{className:"details right"},"A friendly, welcoming look for the HR management web and mobile application at FPT Telecom, Vietnam. Coworkers can also connect through face-to-face video calls with a video conference service built into the app."),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",{className:"right"},"Angular"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",{className:"right"},"OpenVidu API"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",{className:"right"},"Figma")))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"row"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"col-lg-7 offset-lg-5"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Project__WEBPACK_IMPORTED_MODULE_4__["default"],{image0:_assets_images_project3d_png__WEBPACK_IMPORTED_MODULE_10___default.a,image1:_assets_images_project2a_png__WEBPACK_IMPORTED_MODULE_11___default.a,image2:_assets_images_project2b_png__WEBPACK_IMPORTED_MODULE_12___default.a,image3:_assets_images_project2c_png__WEBPACK_IMPORTED_MODULE_13___default.a})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"description left"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2",{className:"category"},"Research Project"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2",{className:"name"},"MyoCare 12"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p",{className:"details left"},"A home-based ECG monitor that detects myocardial infarction in the elderly. Once the system suceeds in collecting and analyzing ECG signals, diagnostic data is uploaded to a web application that allows doctor-patient interaction."),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",{className:"left"},"Firebase"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",{className:"left"},"MATLAB"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",{className:"left"},"Python"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",{className:"left"},"Kit STM32F4")))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"row"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"col-lg-7"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Project__WEBPACK_IMPORTED_MODULE_4__["default"],{image0:_assets_images_project3d_png__WEBPACK_IMPORTED_MODULE_10___default.a,image1:_assets_images_project3a_png__WEBPACK_IMPORTED_MODULE_14___default.a,image2:_assets_images_project3b_png__WEBPACK_IMPORTED_MODULE_15___default.a,image3:_assets_images_project3c_png__WEBPACK_IMPORTED_MODULE_16___default.a})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"description right"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2",{className:"category"},"Team Project"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2",{className:"name"},"Coin Collector"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p",{className:"details right"},"A Python platform game"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",{className:"right"},"PyGame"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",{className:"right"},"graphics.py"))))))));}}/* harmony default export */ __webpack_exports__["default"] = (HomeIndex);

/***/ }),

/***/ "@reach/router":
/*!****************************************************************************************!*\
  !*** external "/Users/khele/Documents/Me/website/node_modules/@reach/router/index.js" ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "lodash":
/*!**********************************************************************************!*\
  !*** external "/Users/khele/Documents/Me/website/node_modules/lodash/lodash.js" ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
